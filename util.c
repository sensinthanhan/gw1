...
void encrypt_cbc(uint8_t* data_encrypted, uint8_t* data, uint8_t* key, uint8_t* iv) { 
    ...
    AES128_CBC_encrypt_buffer(data_encrypted, data_temp, 64, key, iv);
...
void  decrypt_cbc(uint8_t* data_decrypted, uint8_t* data_encrypted, uint8_t* key, uint8_t* iv)  {
    ...
    AES128_CBC_decrypt_buffer(data_decrypted+0,  data_temp+0,  16, key, iv);
    AES128_CBC_decrypt_buffer(data_decrypted+16, data_temp+16, 16, 0, 0);
    AES128_CBC_decrypt_buffer(data_decrypted+32, data_temp+32, 16, 0, 0);
    AES128_CBC_decrypt_buffer(data_decrypted+48, data_temp+48, 16, 0, 0);
    // AES128_CBC_decrypt_buffer(data_decrypted, data_encrypted, 64, key, iv);
    printf("Data decrypt: \n");
